    ...
    <section id="solution" className="border-b border-white/10 bg-[#0c0c0c] relative">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 min-h-[70vh]">
        ...
        <div className="lg:col-span-6 p-6 sm:p-10 lg:p-16 border-b lg:border-b-0 lg:border-r border-white/10 flex flex-col justify-between group">
          ...
          <div className="relative w-full aspect-[4/5] bg-[#111111] overflow-hidden border border-white/10 flex items-center justify-center p-8">
            <img
            ...
            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-3 p-4">
              <button
                ...
                className="px-4 py-3 bg-white text-black font-head text-xs tracking-wider flex items-center gap-2 hover:bg-white/90 transition-all font-bold"
              >
        ...
        <div className="lg:col-span-6 p-8 sm:p-12 lg:p-16 flex flex-col justify-between bg-[#0e0e0e]">
          <div>
            ...
            <h2 className="font-head text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[0.95] text-white uppercase">
              ENTER <br />
              <span className="font-accent italic text-white/90 lowercase">noctra</span>.
            </h2>

            <p className="font-body text-sm sm:text-base text-white/70 font-light leading-relaxed mt-6">
          ...
          {/* Quick Add Bar for the Spotlight Item */}
          <div className="mt-8 pt-6 border-t border-white/10 space-y-3">
              ...
              <div className="flex gap-1.5">
                {(['S', 'M', 'L', 'XL'] as const).map((sz) => (
                  <button
                    ...
                    className={`w-7 h-7 text-xs font-mono font-bold flex items-center justify-center border transition-all ${
                      selectedSize === sz
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 py-3.5 bg-white text-black font-head text-xs tracking-widest uppercase font-bold hover:bg-white/90 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
              ...
              <button
                onClick={() => openProductModal(combatPant)}
                className="px-4 py-3.5 border border-white/20 text-white font-mono text-xs hover:border-white transition-all flex items-center justify-center"
